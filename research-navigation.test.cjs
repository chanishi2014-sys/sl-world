...
has('service-worker.js',"const VERSION = 'v32'");for(const f of ['research.html','research.css','responsibility-lab.html'])has('service-worker.js',`'${f}'`);console.log('PASS PWA v32 assets');
