...
has('service-worker.js',"const VERSION = 'v31'");for(const f of ['research.html','research.css','responsibility-lab.html'])has('service-worker.js',`'${f}'`);console.log('PASS PWA v31 assets');
